...
export class ReportTemplateService {
  ...
  /** Generate a Vaysen Packaging Chinese HTML background-check report. */
...
<p><strong>合作模式：</strong>${this.esc(pm.cooperationModel || '')}</p></div>`;
  ...
  private footer(date: string): string {
    return `<div class="footer"><p>本报告基于公开可查的网络信息编制，仅供参考。报告日期：${date}</p><p>Generated by Vaysen 外贸系统 — AI Deep Research Engine</p></div>`;
  }
